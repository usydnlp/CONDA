...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=False, log_device_placement=log_device_placement)) as sess:
    ...
    while True:
        ...
        if data_processor.end == 1:
            ...
            pickle.dump(test_pred_intent, open( "./results/test_pred_intent"+str(epochs)+".pkl", "wb" ) )
            pickle.dump(test_correct_intent, open( "./results/test_correct_intent"+str(epochs)+".pkl", "wb" ) )
            pickle.dump(test_pred_slot, open( "./results/test_pred_slot"+str(epochs)+".pkl", "wb" ) )
            pickle.dump(test_correct_slot, open( "./results/test_correct_slot"+str(epochs)+".pkl", "wb" ) )
