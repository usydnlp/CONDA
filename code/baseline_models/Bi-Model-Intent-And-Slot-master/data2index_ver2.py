        ...
        for line in f.readlines():
            ...
            for index, item in enumerate(line):
                ...
                try:
                  ...
                  sample_slot.append(slot_dict['UNK'])
                try:
                  train_intent = intent_dict[ line[-1].split(';')[0] ]
                  # print('train_intent:',line[-1].split(';')[0])
                except:
                  train_intent = intent_dict['UNK']
            ...
            if len(sample_sentence) > cfg.max_len:
              sample_sentence = sample_sentence[:cfg.max_len]
              sample_slot = sample_slot[:cfg.max_len]
              real_length = cfg.max_len
            # print('sample_sentence:',len(sample_sentence))
            # print('real_length:',real_length)
            # print('sample_slot:',len(sample_slot))
            # print('train_intent:',train_intent)
            # print(1/0)
