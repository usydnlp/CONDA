...
if __name__ == '__main__':
    ...
    # game bert config
    parser.add_argument("--do_separate", default=0, type=int, help="do_separate.")
    parser.add_argument("--is_game_bert", default=0, type=int, help="is_game_bert.")
    parser.add_argument("--game_bert_model_dir", default=None, type=str, help="Path to load game bert model")
